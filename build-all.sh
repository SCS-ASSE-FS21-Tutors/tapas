...
mvn $1 -f tapas-microservice-base/pom.xml install
...
mvn $1 -f tapas-executor-3/pom.xml --batch-mode --update-snapshots verify
...
cp ./tapas-executor-3/target/tapas-executor-3-0.0.1-SNAPSHOT.jar ./data
